    ...
    >
      ...
      <section className="py-16 px-6 md:px-12">
        <div className="text-center mb-12">
          ...
          <p style={styles.mutedText} className="max-w-2xl mx-auto">
            Explore some of my recent works that showcase my design approach and
            technical skills.
          </p>
        </div>
      ...
      >
        <div className="text-center mb-12">
          ...
          <p style={styles.mutedText} className="max-w-2xl mx-auto">
            I specialize in creating user-centered digital experiences through a
            combination of design and development skills.
          </p>
        </div>
