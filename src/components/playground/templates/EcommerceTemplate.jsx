    ...
    >
      <div className={containerWidthClass}>
        ...
        {showAnnouncement && (
          ...
          >
            <span>
              Free shipping on all orders over $50 | Use code WELCOME20 for 20%
              off
            </span>
          </div>
        )}
        ...
        {showHeader && (
          <header
            style={styles.header}
            className={`${densityClass} px-4 md:px-8 ${contentAlignmentClass}`}
          >
        ...
        {showHero && (
          <section
            className={`py-12 px-4 md:px-8 md:py-16 flex flex-col ${contentAlignmentClass} text-white`}
            style={{
          ...
          >
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-lg mb-8 opacity-90">
                Discover our latest collection of summer products. Fresh
                designs, vibrant colors, and premium quality.
              </p>
        ...
        {/* Categories */}
        {showCategories && (
          <section className={`py-12 ${spacingClass} ${contentAlignmentClass}`}>
            <h2 className="text-2xl font-bold mb-8">Shop by Category</h2>
            <div className={`grid ${gridColumnsClass} gap-4 md:gap-6`}>
              {[
                {
                  name: "Clothing",
        ...
        {showFeaturedProducts && (
          <section
            className={`py-12 ${spacingClass} bg-opacity-50 ${contentAlignmentClass}`}
                    ...
                    {product.tag && (
                      <div
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          console.log(
                            `${product.tag.toUpperCase()} tag clicked`
                          );
                        }}
                      >
        ...
        {showPromotion && (
          <section
            className={`py-12 px-4 md:px-8 text-white ${contentAlignmentClass}`}
            style={{
            ...
            <div className={`grid ${gridColumnsClass} gap-6`}>
              {[
                ...
                <div
                  ...
                  onClick={() =>
                    console.log(`Trending ${product.name} clicked`)
                  }
                >
                  <div
        ...
        {showFooter && (
          <footer
            style={styles.footer}
            className={`py-12 ${spacingClass} mt-auto ${contentAlignmentClass}`}
          >
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
              <div>
                ...
                <p style={styles.mutedText} className="mb-4">
                  Your one-stop shop for all your fashion needs. Quality
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {["All Products", "New Arrivals", "Sale", "Best Sellers"].map(
                    (item) => (
                      <li key={item}>
                        <a
                          href="#"
                          ...
                          onClick={(e) => {
                            e.preventDefault();
                            console.log(`Footer ${item} link clicked`);
                          }}
                        >
                          {item}
                        </a>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {["Our Story", "Blog", "Careers", "Store Locations"].map(
                    (item) => (
                      <li key={item}>
                        <a
                          href="#"
            ...
            <div className="pt-8 border-t" style={{ borderColor: border }}>
              <p style={styles.mutedText} className="text-center">
